...
public class DatabaseIntiator implements ApplicationRunner {
    ...
    private void initiator(){
        ...
        User user1 = new User("user@gmail.com", bCryptPasswordEncoder.encode("123"), "Normal","User", "092200293", "242656789", UserType.ROLE_CUSTOMER ,Gender.MALE, "11-11-2000");
        User user2 = new User("ah@gmail.com", bCryptPasswordEncoder.encode("2345"), "Ahasanul","Khan", "0684611580", "765569753", UserType.ROLE_EMPLOYEE ,Gender.MALE, "21-10-1999");
        User user3 = new User("tanvir@gmail.com", bCryptPasswordEncoder.encode("123"), "Tanvir", "barri", "068755415", "876576524", UserType.ROLE_CUSTOMER, Gender.FEMALE, "11-11-2000");
        User user4 = new User("asif@gmail.com", bCryptPasswordEncoder.encode("1234"), "Asif", "iqbal", "092220029", "878651434", UserType.ROLE_EMPLOYEE, Gender.MALE, "21-10-2000");
...
//
//    }
        LocalDateTime specificTime = LocalDateTime.of(2025, 6, 1, 10, 30);
